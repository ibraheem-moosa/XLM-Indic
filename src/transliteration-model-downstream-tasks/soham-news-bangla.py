...
indic_glue_sna = load_dataset('indic_glue', 'sna.bn')
...
class SohamNewsClassification(Dataset):
...
train_dataset = SohamNewsClassification(indic_glue_sna, tokenizer, 'train')
valid_dataset = SohamNewsClassification(indic_glue_sna, tokenizer, 'validation')
...
for seed in [101, 102, 103, 104, 105, 106, 107, 108, 109]:
    ...
    test_dataset = SohamNewsClassification(indic_glue_sna, tokenizer, 'test')
