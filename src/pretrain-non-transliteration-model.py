...
data_collator = DataCollatorForLanguageModeling(tokenizer=tokenizer, pad_to_multiple_of=32)
...
training_args = TrainingArguments(output_dir='non-transliteration-model-outputs', do_train=True, per_device_train_batch_size=32, per_device_eval_batch_size=32, 
